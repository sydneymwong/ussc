...
FILENAME datafile 'H:\opafy17-nid\opafy17nid.dat' ;

/* The following line should contain the directory in which you wish your SAS file to be stored */
libname library 'H:\opafy17-nid' ;
...
proc transpose data = library.&dataset(obs=0) out=names ;
var _all_;
run;

data _null_;
	set names end=eof;
	file 'H:\opafy17-nid\opafy17nid.csv' dsd lrecl=2000000;
put _name_@;
if eof then put ;
run;
...
data _null_;
	set library.&dataset;
    file 'H:\opafy17-nid\opafy17nid.csv' mod dsd lrecl=2000000;
    put (_all_) (+0);
    replace;
run;
